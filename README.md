...
- 우승현(팀장): 저희 조는 직장인 및 대학원 팀으로서 github의 팀 결성에 실패했으며 단체 회의 없이 개인 각각이 별도의 활동을 진행하게 됐습니다. 해당 page에서는 OCR 2조 우승현이 진행한 내용을 바탕으로만 적게 됐습니다. 다른 팀은 별도로 제출이 이루어질 것으로 보입니다.
